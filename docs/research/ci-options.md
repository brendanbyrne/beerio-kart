...
- 2026-05-15 — Updated path references for the entity-codegen-strategy and design-doc-restructure records (both now archived under `docs/designs/archive/`). Companion to PR [#160](https://github.com/brendanbyrne/beerio-kart/pull/160) / Issue [#159](https://github.com/brendanbyrne/beerio-kart/issues/159).
